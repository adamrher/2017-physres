...
\cite{HL2018MWR} documents the alogrithms used to separate the physics and dynamics grids, and discusses how the use of a finite-volume physics grid is more consistent with approximations made by the physics, and in the coupling to other model components. mainly that   A finite-volume physics grid was chosen such that their are equal degrees of freedom on both
