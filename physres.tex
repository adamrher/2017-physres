...
\begin{keypoints}
\item Each control volume has the same smoothness properties
\item Grid imprinting is eliminated, even in regions with steep terrain
