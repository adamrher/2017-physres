...
\end{center}
\caption{Indice notation for the (Left) pg2 grid, (Middle), pg3 grid and (Right) their exchange grid.}
...
\begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=30pc,angle=0]{figs/temp_pdf-omg-panel-degree.pdf}\\
\end{center}
