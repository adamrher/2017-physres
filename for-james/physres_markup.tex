...
\begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=30pc,angle=0]{area-schematic.png}\\
\end{center}
...
\begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=30pc,angle=0]{alg-schematic.png}\\
\end{center}
...
\begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=30pc,angle=0]{fhstopo_ne30pg2-v-ne30pg3-v-10Xnudiv.pdf}\\
\end{center}
...
\begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=25pc,angle=0]{fhstopo_Divergence_ne30pg2-v-ne30pg3-v-10Xnudiv.pdf}\\
\end{center}
...
\begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=30pc,angle=0]{panel_transGLL.pdf}\\
\end{center}
...
\begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=30pc,angle=0]{panel_ne20pg2-ne30pg2-ne30pg3.pdf}\\
\end{center}
...
The experiment described in the previous section is repeated here for a $ne120pg2$ aqua-planet simulation, corresponding to an approximate grid spacing of $\Delta x_{dyn} = 27.8km$ and $\Delta x_{phys} = 41.7km$. $ne80pg3$ refers to the grid in which the physics and dynamics are the same resolution as the physics of the $ne120pg2$ grid, and $ne120pg3$, the grid in which the physics and dynamics are equal to the resolution of the dynamics of $ne120pg2$. At these higher resolutions, the solutions are sensitive to $\Delta t_{phys}$ (Figure~\ref{fig:pdf-dtphys}), and so the $ne80$ grid uses a larger time-step than that of the $ne120$ grids (Table~\ref{table:grids-hi}), following equation~\eqref{eq:dt-scale}.
 ...
 \begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=30pc,angle=0]{panel_ne80pg3_ne120pg2_ne120pg3.pdf}\\
\end{center}
...
\begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=30pc,angle=0]{panel_diags.pdf}\\
\end{center}
...
\begin{figure}[t]
\begin{center}
\noindent\includegraphics[width=30pc,angle=0]{panel_loworder.pdf}\\
\end{center}
